...
object Versions {
    ...
    const val androidGradlePlugin = "7.0.4" // update also build.gradle.kts in buildSrc
    ...
    const val dagger = "2.40.5" // update also build.gradle.kts in buildSrc
