...
import com.dbottillo.departnow.feature.about.navigation.ABOUT_NAVIGATION_ROUTE
import com.dbottillo.departnow.feature.about.navigation.navigateToAbout
import com.dbottillo.departnow.feature.home.navigation.HOME_NAVIGATION_ROUTE
import com.dbottillo.departnow.feature.home.navigation.navigateToHome
import com.dbottillo.departnow.navigation.TopLevelDestination

@Composable
fun rememberDepartNowAppState(
    navController: NavHostController = rememberNavController(),
): DepartNowAppState {
    NavigationTrackingSideEffect(navController)
    return remember(navController) {
        DepartNowAppState(navController)
    }
}

@Stable
class DepartNowAppState(
