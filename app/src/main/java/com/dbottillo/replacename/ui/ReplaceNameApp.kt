...
import com.dbottillo.replacename.designsystem.LocalCustomColors
import com.dbottillo.replacename.designsystem.components.ReplaceNameTopAppBar
import com.dbottillo.replacename.navigation.ReplaceNameNavHost
...
@Composable
fun ReplaceNameApp(
    appState: ReplaceNameAppState = rememberReplaceNameAppState()
) {
